CREATE OR REPLACE PROCEDURE  LOAD_DIM_GEOGRAPHY
IS
    ...
    V_TABLE_NAME            VARCHAR2(30) := 'STG_DIM_GEOGRAFIA';
    V_TABLE_ID_NAME         VARCHAR2(30) := 'GEOGRAFIA_IDW';
...
BEGIN
    ...
    INSERT INTO  STG_DIM_GEOGRAFIA(ADRESS, CITY, REGION, POSTALCODE, COUNTRY)
    SELECT  CUST.ADDRESS, CUST.CITY, CUST.REGION, CUST.POSTALCODE, CUST.COUNTRY
    FROM ORDERS_DB.CUSTOMERS CUST JOIN ORDERS_DB.EMPLOYEES EMP ON CUST.COUNTRY = EMP.COUNTRY;
