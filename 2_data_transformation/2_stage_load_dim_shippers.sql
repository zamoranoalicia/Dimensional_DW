CREATE OR REPLACE PROCEDURE  LOAD_DIM_SHIPPERS
IS
    ...
    V_TABLE_NAME            VARCHAR2(30) := 'STG_DIM_SHIPPERS';
    V_TABLE_ID_NAME         VARCHAR2(30) := 'IDW_SHIPPERS';
...
BEGIN
    ...
    INSERT INTO  STG_DIM_SHIPPERS(SHIPPERID,
                                  SHIPPERS,
                                  PHONE)
    SELECT SHIPPERID,
           COMPANYNAME,
           PHONE FROM ORDERS_DB.SHIPPERS;
